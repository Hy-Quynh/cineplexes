...
module.exports = {
  ...
  getFare: async (movieID, cinemaID, showAt) => {
    return db.query('SELECT st.fare FROM ticket t JOIN booking b ON t."bookingID" = b."_bookingID" JOIN showtime st ON st."cinemaID" = b."cinemaID" WHERE st."movieID" = :movie_Id AND st."cinemaID" = :cinema_Id AND st."showAt" = :show_at', {
      type: QueryTypes.SELECT,
      plain: true,
      replacements: {
        movie_Id: movieID,
